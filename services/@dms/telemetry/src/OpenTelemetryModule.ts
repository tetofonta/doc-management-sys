...
import { OpenTelemetryModuleConfig, OpenTelemetryModuleDefaultConfig } from './OpenTelemetryModuleConfig';
...
export class OpenTelemetryModule {
    ...
    static async forRootAsync(configuration: OpenTelemetryModuleAsyncOption = {}): Promise<DynamicModule> {
        return {
            global: true,
            module: OpenTelemetryModule,
    ...
    private static buildInjectors(configuration?: Partial<OpenTelemetryModuleConfig>): FactoryProvider {
        const injectors = configuration?.traceAutoInjectors ?? [];
        return {
